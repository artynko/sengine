...
public final class Mat4 extends AbstractMat {
	...
	public Vec4 multiply(final Vec4 vec) {
        ...
        public Mat4 multiply(final float scalar) {            

            float nm00 = this.m00 * scalar;
            float nm01 = this.m01 * scalar;
            float nm02 = this.m02 * scalar;
            float nm03 = this.m03 * scalar;
            float nm10 = this.m10 * scalar;
            float nm11 = this.m11 * scalar;
            float nm12 = this.m12 * scalar;
            float nm13 = this.m13 * scalar;
            float nm20 = this.m20 * scalar;
            float nm21 = this.m21 * scalar;
            float nm22 = this.m22 * scalar;
            float nm23 = this.m23 * scalar;
            float nm30 = this.m30 * scalar;
            float nm31 = this.m31 * scalar;
            float nm32 = this.m32 * scalar;
            float nm33 = this.m33 * scalar;
