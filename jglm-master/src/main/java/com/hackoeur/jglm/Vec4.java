...
public final class Vec4 extends AbstractVec {
	...
	public Vec4 multiply(final Vec4 vec4) {
		return new Vec4( x * vec4.getX(), y * vec4.getY(), z * vec4.getZ(), w * vec4.getW());
	}
	...
	public Vec4 multiply(final Mat4 mat) {
		/*
		return new Vec4(
				mat.m00 * x + mat.m01 * y + mat.m02 * z + mat.m3 * w,
		...
		*/
		...
		/*
		return new Vec4(
				mat.m00 * x + mat.m10 * x + mat.m20 * x + mat.m30 * x,
				mat.m01 * y + mat.m11 * y + mat.m21 * y + mat.m31 * y,
				mat.m02 * z + mat.m12 * z + mat.m22 * z + mat.m32 * z,
				mat.m03 * w + mat.m13 * w + mat.m23 * w + mat.m33 * w
		);
		*/
		/*
		return new Vec4(
				mat.m00 * x + mat.m01 * x + mat.m02 * x + mat.m03 * x,
				mat.m10 * y + mat.m11 * y + mat.m12 * y + mat.m13 * y,
				mat.m20 * z + mat.m21 * z + mat.m22 * z + mat.m23 * z,
				mat.m30 * w + mat.m31 * w + mat.m32 * w + mat.m33 * w
		);
		*/
	}
	@Override
