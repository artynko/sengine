...
class TilesBlockGrass(ai: Int) extends CompositeEntity with StaticEntity with FlatShader with Guid with Textured with NonCulled with AlphaTexture with AlphaIndex {
  val alphaIndex = ai
  val textureName = "textures/grass_light_dark.png"
